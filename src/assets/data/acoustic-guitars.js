...
const products = [
  {
    ...
    image:
      'https://www.ibanez.com/common/product_artist_file/file/ps_main_ag_artwood_traditional_acoustic_en.png',
    features: [
      {
        title:
        ...
        image:
          'https://www.ibanez.com/asia/products/model/az/news_file/file/feat_AZS2209H_pu.jpg',
      },
      {
        title: 'Gotoh® F1803 bridge',
        text: 'The Gotoh® F1803 bridge improves sustain and tuning stability.',
        image:
          'https://www.ibanez.com/asia/products/model/az/news_file/file/feat_AZS2209H_bridge.jpg',
      },
      {
        title: 'dyna-MIX5 switching system with Alter Switch',
        text:
          'The dyna-MIX5 switching system with Alter Switch adds a sound variation to fit so many different kinds of playing style.',
        image:
          'https://www.ibanez.com/asia/products/model/az/news_file/file/feat_dyna-MIX5.jpg',
      },
      {
        title: 'Gotoh®/Ibanez co-designed "In-Tune" saddles',
        text:
          'These saddles are equipped with grooves which actively prevent each string from slipping to the side. The saddles also feature rounded edges and deeper grooves on 1st and 6th strings, which means much less saddle tilting is required to adjust the string height, and equal string spacing is more easily achieved. Additionally, the saddles are designed with pre-calculated “intonation points” where the string touches the saddle, allowing each string to have and maintain precise intonation. The 10.5mm string spacing allows for easy picking across strings. The saddles themselves are made of titanium for maximum tonal clarity.',
        image:
          'https://www.ibanez.com/asia/products/model/az/news_file/file/feat_AZS2209H_saddle.jpg',
      },
    ],
  },
  {
    ...
    image:
      'https://www.ibanez.com/common/product_artist_file/file/p_region_AW84_WK_1P_01.png',
    features: [
      {
        title:
          'Seymour Duncan® Magic Touch-mini™ / Alnico II Pro™ Custom pickups',
  ...
  },
  {
    ...
    image:
      'https://www.ibanez.com/common/product_artist_file/file/p_region_AW54JR_OPN_1P_01.png',
    features: [
      {
        title:
          'Seymour Duncan® Magic Touch-mini™ / Alnico II Pro™ Custom pickups',
